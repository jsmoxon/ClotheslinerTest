...
"leg": #a function of (Cuff + Knee + Thigh) divided by (waist + totalRise + outseam)
{
	...
	"negative":
		{
		1: "It will taper slightly more all the way down which is traditionally called a tapered fit.",
		2: "It will taper noticably more all the way down the leg so it will be feel slimmer.",
		3: "It will taper a lot more down the leg which is how the kids are wearing it these days."
		}
	},	

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Pant_Stock_Item.picURL'
        db.add_column('clothes_pant_stock_item', 'picURL', self.gf('django.db.models.fields.URLField')(max_length=200, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Pant_Stock_Item.picURL'
        db.delete_column('clothes_pant_stock_item', 'picURL')

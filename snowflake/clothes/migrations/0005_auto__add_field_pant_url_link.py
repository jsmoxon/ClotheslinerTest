...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Pant.url_link'
        db.add_column('clothes_pant', 'url_link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Pant.url_link'
        db.delete_column('clothes_pant', 'url_link')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pant.url_link'
        db.alter_column('clothes_pant', 'url_link', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))

        # Changing field 'Pant.picURL'
        db.alter_column('clothes_pant', 'picURL', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))


    def backwards(self, orm):
        
        # Changing field 'Pant.url_link'
        db.alter_column('clothes_pant', 'url_link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Pant.picURL'
        db.alter_column('clothes_pant', 'picURL', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

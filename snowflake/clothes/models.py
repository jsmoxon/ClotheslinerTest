...
class Pant(Cloth_Item):
	...
	retailer1_name = models.CharField(max_length=200, null=True, blank=True)
	retailer1_price = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
	retailer1_location = models.CharField(max_length=200, null=True, blank=True)
	retailer1_url = models.URLField(null=True, blank=True)
	retailer1_description = models.CharField(max_length=1000, null=True, blank=True)
	retailer1_shipping = models.CharField(max_length=500, null=True, blank=True)
	retailer1_returns = models.CharField(max_length=500, null=True, blank=True)
	retailer2_name = models.CharField(max_length=200, null=True, blank=True)
	retailer2_price = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
	retailer2_location = models.CharField(max_length=200, null=True, blank=True)
	retailer2_url = models.URLField(null=True, blank=True)
	retailer2_description = models.CharField(max_length=1000, null=True, blank=True)
	retailer2_shipping = models.CharField(max_length=500, null=True, blank=True)
	retailer2_returns = models.CharField(max_length=500, null=True, blank=True)
	retailer3_name = models.CharField(max_length=200, null=True, blank=True)
	retailer3_price = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
	retailer3_location = models.CharField(max_length=200, null=True, blank=True)
	retailer3_url = models.URLField(null=True, blank=True)
	retailer3_description = models.CharField(max_length=1000, null=True, blank=True)
	retailer3_shipping = models.CharField(max_length=500, null=True, blank=True)
	retailer3_returns = models.CharField(max_length=500, null=True, blank=True)
	retailer4_name = models.CharField(max_length=200, null=True, blank=True)
	retailer4_price = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
	retailer4_location = models.CharField(max_length=200, null=True, blank=True)
	retailer4_url = models.URLField(null=True, blank=True)
	retailer4_description = models.CharField(max_length=1000, null=True, blank=True)
	retailer4_shipping = models.CharField(max_length=500, null=True, blank=True)
	retailer4_returns = models.CharField(max_length=500, null=True, blank=True)
	retailer5_name = models.CharField(max_length=200, null=True, blank=True)
	retailer5_price = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
	retailer5_location = models.CharField(max_length=200, null=True, blank=True)
	retailer5_url = models.URLField(null=True, blank=True)
	retailer5_description = models.CharField(max_length=1000, null=True, blank=True)
	retailer5_shipping = models.CharField(max_length=500, null=True, blank=True)
	retailer5_returns = models.CharField(max_length=500, null=True, blank=True)
